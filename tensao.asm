...
ERRO_OPCAO2	db	" ] sem parametro",CR,LF,0	; Mensagem de erro para opÁ„o inv·lida
...
salva_opcao:
	...
	dec	di	; Ajusta o ponteiro para o inÌcio do par‚metro
	inc	cx
...
abre_arquivo:
	...
	; LÍ o arquivo de entrada e escreve no arquivo de saÌda
...
; Obj.: Dada uma string e seu tamanho, percorre a string atÈ encontrar o primeiro caractere depois de um espaÁo
